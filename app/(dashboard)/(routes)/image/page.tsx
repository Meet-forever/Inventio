...
const Conversation = () => {
    ...
    return (
        <div>
            <Heading title="Image" description="Image generation AI model" icon={Image} iconColor="text-pink-700" bgColor="bg-pink-700/10" />
            <div className="px-4 lg:px-8">
                            ...
                            <FormField control={form.control} name="prompt" render={({field}) =>
                                <FormItem className="col-span-12 lg:col-span-10">
                                    <FormControl  className="m-0 p-0">
                                        <Input className="border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent" disabled={isLoading} placeholder="Provide your image prompts here!" {...field} />
                                    </FormControl>
                                </FormItem>
                            } />
                ...
                <div className="space-y-4 mt-4">
                    ...
                    {messages.length === 0 && !isLoading && (<Empty label="No images uwu" />)}
