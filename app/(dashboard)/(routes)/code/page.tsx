...
const Conversation = () => {
    ...
    return (
        <div>
            <Heading title="Code" description="Code generating AI model" icon={Code2} iconColor="text-amber-500" bgColor="bg-amber-500/10" />
            <div className="px-4 lg:px-8">
                            ...
                            <FormField control={form.control} name="prompt" render={({field}) =>
                                <FormItem className="col-span-12 lg:col-span-10">
                                    <FormControl  className="m-0 p-0">
                                        <Input className="border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent" disabled={isLoading} placeholder="Ask me any programming code!" {...field} />
                                    </FormControl>
                                </FormItem>
                            } />
                ...
                <div className="space-y-4 mt-4">
                    ...
                    {messages.length === 0 && !isLoading && (<Empty label="No code uwu" />)}
